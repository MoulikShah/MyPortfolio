...
export const knowledge = [
    ...
    {
        id: "rank-lab",
        text: "rank lab ranking demo feed re-rank interactive recommender playground how does the feed demo work explore exploit",
        question: "What's the Rank Lab on this site?",
        answer:
            "The Rank Lab is a toy version of what Moulik builds at TikTok, running right on this page: a recall pool of local services, a linear ranker over your clicks and dwell time, and a UCB exploration bonus. Interact with the feed and you can watch it re-rank itself and see the learned user model update live.",
    },
    {
        id: "this-site",
